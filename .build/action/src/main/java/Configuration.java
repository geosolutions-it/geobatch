...
public class ##NAME_ACT##Configuration extends ActionConfiguration implements Configuration {

    public ##NAME_ACT##Configuration(String id, String name, String description) {
