...
* Options:
    ...
    * **moveData**: remove copied data from the input feature, if a filter is specified remove just the features filtered. The default value is false.
    * **moveAllData**: remove ALL existing data from the input feature although a filter is specified. If this flag is set to TRUE the flag moveData has no effect. The default value is false.
...
.. sourcecode:: xml
    ...
    <Ds2dsConfiguration>
        ...
        <!-- don't remove data in the input feature after importing -->
