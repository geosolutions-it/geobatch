...
public class FtpServerConfig implements Serializable {
    ...
    public String toString() {
        return new StringBuilder(getClass().getSimpleName()).append('[').append("port:").append(
                getPort()).append(" ssl:").append(isSsl()).append(" maxLogins:").append(
                getMaxLogins()).append(" anon:").append(isAnonEnabled()).append(" maxAnonLogins:")
                .append(getMaxAnonLogins()).append(" maxLoginFailures:").append(
                        getMaxLoginFailures()).append(" loginFailureDelay:").append(
                        getLoginFailureDelay()).append(" auto:").append(isAutoStart()).append(
                        " basedir:").append(getFtpBaseDir()).append(']').toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.ftpBaseDir == null) ? (other.ftpBaseDir != null) : !this.ftpBaseDir
                .equals(other.ftpBaseDir)) {
            return false;
        }
        return true;
    }
