...
public class FtpUser implements User {
    ...
    public String getRelativeHomeDir() {
        return (delegateUser.getRelativeHomeDir() != null ? delegateUser.getRelativeHomeDir()
                : delegateUser.getName().toLowerCase());
    }
    ...
    public String toString() {
        return "[ ID : "
                ...
                + getName()
                // + " - PWD : " + getPassword()
                + " - HOME_DIR : " + getRelativeHomeDir() + " - ENABLE_FLAG : " + getEnabled()
                + " - ROLE : " + getRole() + "][" + " - WRITE_PERMISSION " + isWritePermission()
                + " - IDLE_TIME " + getMaxIdleTime() + " - UPLOAD_RATE " + getUploadRate()
                + " - DOWNLOAD_RATE " + getDownloadRate() + " - MAX_LOGIN_NUMBER "
                + getMaxLoginNumber() + " - MAX_LOGIN_PER_IP " + getMaxLoginPerIp() + "]";
    }
