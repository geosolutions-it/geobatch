...
public class HTTPUtils {
    ...
    public static boolean put(String url, String content, String contentType, String username,
            String pw) {
        try {
    ...
    public static boolean post(String url, String content, String contentType, String username,
            String pw) {
        try {
    ...
    private static boolean send(final EntityEnclosingMethod httpMethod, String url,
        ...
        try {
            ...
            case HttpURLConnection.HTTP_ACCEPTED:
                ...
                return true;
            default:
                LOGGER.warn("Bad response: code[" + status + "]" + " msg["
                        + httpMethod.getStatusText() + "]" + " url[" + url + "]" + " method["
