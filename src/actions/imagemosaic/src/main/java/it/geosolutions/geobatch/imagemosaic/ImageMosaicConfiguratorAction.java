 ...
 * @author AlFa
 * 
 * @version $ ImageMosaicConfiguratorAction.java $ Revision: 0.1 $ 12/feb/07
 *          12:07:06
 */

public abstract class ImageMosaicConfiguratorAction<T extends EventObject>
		extends BaseAction<T> implements Action<T> {
	/**
	 * Default logger
	 */
	protected final static Logger LOGGER = Logger
			.getLogger(ImageMosaicConfiguratorAction.class.toString());
	 ...
	 * @throws IOException
	 */
	public ImageMosaicConfiguratorAction(
	...
	/**
	 * Configures the styles associated in this class'
	 * GeoServerActionConfiguration to the layer passed as parameter.
	 * 
	 * @param layerName
	...
	protected boolean configureStyles(String layerName)
		...
		return configureStyles(layerName, getConfiguration().getDefaultStyle(),
				getConfiguration().getStyles(), getConfiguration()
