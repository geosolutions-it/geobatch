...
public abstract class ImageMosaicConfiguratorAction<T extends EventObject> extends BaseAction<T>
        implements Action<T> {
    /**
     * Default logger
     */
    protected final static Logger LOGGER = Logger.getLogger(ImageMosaicConfiguratorAction.class
            .toString());
     ...
     */
    protected boolean configureStyles(String layerName) throws MalformedURLException,
            FileNotFoundException {
        return configureStyles(layerName, getConfiguration().getDefaultStyle(), getConfiguration()
                .getStyles(), getConfiguration().getGeoserverURL(), getConfiguration()
     ...
     * @throws java.io.FileNotFoundException
     */
    public static boolean configureStyles(String layerName, String defaultStyle,
