 ...
 * 
 */
public class LammaContourBuilderService
        extends BaseService
        implements ActionService<FileSystemMonitorEvent, LammaContourBuilderConfiguration> {

    private final static Logger LOGGER = Logger.getLogger(LammaContourBuilderService.class.toString());
