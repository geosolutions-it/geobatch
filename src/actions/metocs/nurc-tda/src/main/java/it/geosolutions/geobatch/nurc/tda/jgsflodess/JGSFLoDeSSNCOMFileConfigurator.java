		...
		try {
			...
			final List<Dimension> outDimensions = METOCSActionsIOUtils
					.createNetCDFCFGeodeticDimensions(ncFileOut, true,
							...
							METOCSActionsIOUtils.DOWN, true, yIndex.getLength(),
			...
			for (int t = 0; t < timesFound.size(); t++) {
				...
				float timeValue = (timeInstant.getTime() - METOCSActionsIOUtils.startTime) / 1000.0f;
							...
							for (Object obj : ncVarFile.getVariables()) {
								...
								if (!varName.equalsIgnoreCase("X_Index")
									...
									for (int z = 0; z < Depth.getLength(); z++) {
										...
										METOCSActionsIOUtils.write2DData(
												userRaster, var,
										...
										userRaster = METOCSActionsIOUtils
														...
														.setDouble(
																outVarData
																		...
																		.set(
																				...
																				y,
																				x),
																(originalValue != noData ? METOCSActionsIOUtils
																		.rescaleValue(
																				originalValue,
																				scale,
																				offset)
			...
			ncFileOut.write(METOCSActionsIOUtils.DEPTH_DIM, zeta1Data);
			if (packComponents) {
