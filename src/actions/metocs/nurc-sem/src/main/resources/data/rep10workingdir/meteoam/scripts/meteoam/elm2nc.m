...
%
%  This script reads ELM gribs and converts to NetCDF
...
%DEBUG
%  datestr(du)
%  ut.pds.hour+ut.pds.P1+ut.pds.P2
%  ut.pds.hour
%  ut.pds.P1
%  ut.pds.P2
%      
...
%          if (nn>1)
%    	disp('DIFFERENCE:--------------->')
%    	((du-datenum(1980,1,1))*3600*24)-seconds
%          end
%          disp('days:--------------->')
%          du-datenum(1980,1,1)
%          disp('date:--------------->')
...
%DEBUG
%  datestr(datenum(1980,1,1,0,0,seconds))
...
%        f{'rain'}.long_name='Total Accumualted Precipitation';
%        f{'rain'}.coordinates='lat lon';

      % nodata
      f.nodata=ncfloat(1.e35);
      % fillvalue
      f._FillValue= ncfloat(1.e35);
      %base time attribute
      %"yyyyMMddTHHmmssSSSZ"
