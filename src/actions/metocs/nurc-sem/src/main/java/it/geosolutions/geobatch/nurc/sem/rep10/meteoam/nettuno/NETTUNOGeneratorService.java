...
package it.geosolutions.geobatch.nurc.sem.rep10.meteoam.nettuno;
...
public class NETTUNOGeneratorService
    extends BaseService 
...
//TODO check if the m file is present and is readable
    ...
    public NETTUNOAction createAction(final OctaveActionConfiguration configuration) {
        if(canCreateAction(configuration)){
            return new NETTUNOAction(configuration);
        }
        return null;
    }
