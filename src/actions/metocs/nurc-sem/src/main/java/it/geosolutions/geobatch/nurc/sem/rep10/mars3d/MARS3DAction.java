    ...
    public Queue<FileSystemMonitorEvent> execute(Queue<FileSystemMonitorEvent> events)
        ...
        try {
            ...
            if ((ev)!=null){
                 ...
                 */
                File out_dir=new File(config.getWorkingDirectory()+File.separator+OUTPUT_DIR+File.separator);
                if (!out_dir.exists()){
                    if (!out_dir.mkdir()){
                 ...
                 */
                DefaultSheetBuilder fb=new MARS3DSheetBuilder(ev.getSource().getAbsolutePath(),out_name);
