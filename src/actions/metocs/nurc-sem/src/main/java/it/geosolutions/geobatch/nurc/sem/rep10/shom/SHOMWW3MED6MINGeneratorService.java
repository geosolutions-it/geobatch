 ...
 * 
 */
public class SHOMWW3MED6MINGeneratorService extends BaseService implements
        ActionService<FileSystemMonitorEvent, MetocActionConfiguration> {

    private final static Logger LOGGER = Logger.getLogger(SHOMWW3MED6MINGeneratorService.class
            .toString());
    ...
    public Action<FileSystemMonitorEvent> createAction(MetocActionConfiguration configuration) {
