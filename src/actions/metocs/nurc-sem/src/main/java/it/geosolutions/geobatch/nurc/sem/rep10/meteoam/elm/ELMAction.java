...
package it.geosolutions.geobatch.nurc.sem.rep10.meteoam.elm;
...
public class ELMAction extends FileInFileOutAction {

    public ELMAction(OctaveActionConfiguration actionConfiguration) {
    ...
    protected String buildFileName(){
        return "rep10_ELM-Forecast-T" + new Date().getTime()+".nc";
    }
