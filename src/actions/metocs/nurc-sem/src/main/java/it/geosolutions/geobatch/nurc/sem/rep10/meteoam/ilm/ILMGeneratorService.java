...
package it.geosolutions.geobatch.nurc.sem.rep10.meteoam.ilm;
...
public class ILMGeneratorService
    extends BaseService 
...
//TODO check if the m file is present and is readable
    ...
    public ILMAction createAction(final OctaveActionConfiguration configuration) {
        if(canCreateAction(configuration)){
            return new ILMAction(configuration);
        }
        return null;
    }
