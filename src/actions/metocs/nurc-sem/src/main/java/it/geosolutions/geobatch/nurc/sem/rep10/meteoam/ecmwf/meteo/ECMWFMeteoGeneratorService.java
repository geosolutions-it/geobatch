...
package it.geosolutions.geobatch.nurc.sem.rep10.meteoam.ecmwf.meteo;
...
public class ECMWFMeteoGeneratorService
    extends BaseService 
...
//TODO check if the m file is present and is readable
    ...
    public ECMWFMeteoAction createAction(final OctaveActionConfiguration configuration) {
        if(canCreateAction(configuration)){
            return new ECMWFMeteoAction(configuration);
        }
        return null;
    }
