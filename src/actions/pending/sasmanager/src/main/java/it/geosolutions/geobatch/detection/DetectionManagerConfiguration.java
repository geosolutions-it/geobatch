 ...
 */
public class DetectionManagerConfiguration extends ActionConfiguration implements Configuration {

	public DetectionManagerConfiguration(String id, String name, String description, boolean dirty) {
