 ...
 *
 */
@Action(configurationClass=GeonetworkDeleteConfiguration.class,configurationAlias="GeonetworkDelete")
public class GeonetworkDeleteAction extends BaseAction<FileSystemEvent> {

	private final static Logger LOGGER = LoggerFactory.getLogger(GeonetworkDeleteAction.class);

	final GeonetworkConfiguration cfg;

	public GeonetworkDeleteAction(GeonetworkConfiguration configuration) {
		super(configuration);
		cfg = configuration;
	}
	...
	public boolean checkConfiguration() {
		return cfg instanceof GeonetworkDeleteConfiguration;
	}
