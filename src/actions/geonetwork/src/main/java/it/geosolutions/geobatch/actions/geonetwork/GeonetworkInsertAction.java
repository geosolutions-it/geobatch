 ...
 *
 */
@Action(configurationClass=GeonetworkInsertConfiguration.class,configurationAlias="GeonetworkInsert")
public class GeonetworkInsertAction extends BaseAction<FileSystemEvent> {

	private final static Logger LOGGER = LoggerFactory.getLogger(GeonetworkInsertAction.class);

	final GeonetworkConfiguration cfg;

	public GeonetworkInsertAction(GeonetworkConfiguration configuration) {
		super(configuration);
		cfg = configuration;
	}
