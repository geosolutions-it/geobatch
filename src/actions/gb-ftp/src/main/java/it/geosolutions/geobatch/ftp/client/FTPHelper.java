 ...
 * @author Ivano Picco
 * 
 * @deprecated This class won't throw Exceptions, so errors will be diffucult to
 *             identify. You may want to use {@link FTPHelperBare}
 */
public class FTPHelper {
	 ...
	 */
	public static boolean putBinaryFileTo(String ftpserverHost,
			String binaryFile, String path, String ftpserverUser,
			String ftpserverPassword, int ftpserverPort, WriteMode writeMode,
	...
	private static boolean putFile(String ftpserverHost, String binaryFile,
		...
		try {
			...
			if (remoteFileNameReturned != null)
				res = true;
	 ...
	 */
	public static boolean createDirectory(String ftpserverHost,
			String binaryFile, String path, String ftpserverUser,
	 ...
	 */
	public static boolean downloadFile(String ftpserverHost, String localPath,
	 ...
	 *         deleted.
	 */
	public static boolean deleteFileOrDirectory(String ftpserverHost,
