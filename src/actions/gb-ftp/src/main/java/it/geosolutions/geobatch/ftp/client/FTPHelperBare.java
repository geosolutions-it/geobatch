...
public class FTPHelperBare {
    ...
    public static void putBinaryFileTo(String ftpserverHost, String binaryFile, String path,
            String ftpserverUser, String ftpserverPassword,int ftpserverPort, WriteMode writeMode, FTPConnectMode connectMode, int timeout ) throws IOException, FTPException {
    ...
    private static FTPClient connectTo(String ftpserverHost, String ftpserverUser,
			...
			WriteMode writeMode, FTPConnectMode connectMode, int timeout) throws FTPException, IOException{
	 ...
	 */
	private static void putFile(String ftpserverHost, String binaryFile, String path, String ftpserverUser,
			String ftpserverPassword, int ftpserverPort, FTPTransferType transferType,
			WriteMode writeMode, FTPConnectMode connectMode, int timeout) throws IOException, FTPException {
...
//            res = false;
	 ...
	 */
	public static void createDirectory(String ftpserverHost, String binaryFile, String path, String ftpserverUser,
			String ftpserverPassword, int ftpserverPort, FTPTransferType transferType,
			WriteMode writeMode, FTPConnectMode connectMode, int timeout) throws IOException, FTPException{
...
//		return res;
	 ...
	 */
	public static void downloadFile(String ftpserverHost, String localPath, String remotePath, String remoteFile, String ftpserverUser,
			String ftpserverPassword, int ftpserverPort, FTPTransferType transferType,
			WriteMode writeMode, FTPConnectMode connectMode, int timeout) throws IOException, FTPException{
...
//		return res;
	...
	public static FTPFile[] dirDetails(String ftpserverHost, String dirName, String remotePath, String ftpserverUser,
			String ftpserverPassword, int ftpserverPort, FTPTransferType transferType,
			WriteMode writeMode, FTPConnectMode connectMode, int timeout) throws IOException, FTPException, ParseException{
...
//        else return null;
	 ...
	 */
	public static void deleteFileOrDirectory(String ftpserverHost, String remoteFile, boolean isDir, String remotePath, String ftpserverUser,
			String ftpserverPassword, int ftpserverPort, FTPConnectMode connectMode, int timeout) throws FTPException, IOException{
