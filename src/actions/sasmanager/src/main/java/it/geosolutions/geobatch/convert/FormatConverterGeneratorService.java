 ...
 */
public class FormatConverterGeneratorService 
	extends FormatConverterConfiguratorService<FileSystemMonitorEvent, FormatConverterConfiguration> {

	private final static Logger LOGGER = Logger.getLogger(FormatConverterGeneratorService.class.toString());
