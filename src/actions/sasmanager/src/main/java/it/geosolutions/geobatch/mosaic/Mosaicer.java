...
import it.geosolutions.geobatch.base.BaseMosaicer;
 ...
 */
public class Mosaicer extends BaseMosaicer {
	 ...
	 * @throws IOException
	 */
    public Mosaicer(ActionConfiguration actionConfiguration) throws IOException {
