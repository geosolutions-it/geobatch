 ...
 */
public abstract class DetectionManagerConfiguratorService<T extends EventObject, C extends ActionConfiguration>
        extends BaseService implements ActionService<T, C> {

    public DetectionManagerConfiguratorService() {
        super(true);
    }
