...
package it.geosolutions.geobatch.nurc.commons;
 ...
 */
public class NURCActionsAliasRegistrar extends AliasRegistrar {

	public NURCActionsAliasRegistrar(AliasRegistry registry) {
