...
package it.geosolutions.geobatch.nurc.registry;
...
public abstract class RegistryConfiguratorAction
 		extends BaseAction<FileSystemMonitorEvent> implements Action<FileSystemMonitorEvent> {
	/**
     * Default logger
     */
    protected final static Logger LOGGER = Logger.getLogger(RegistryConfiguratorAction.class.toString());
