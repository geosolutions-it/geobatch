...
public class DSGeoServerConfiguration extends GeoServerActionConfiguration {
	 ...
	 * @param description
	 */
	public DSGeoServerConfiguration(String id, String name,
			String description) {
	...
	@Override
    public DSGeoServerConfiguration clone() { 
        final DSGeoServerConfiguration configuration = (DSGeoServerConfiguration) super
                .clone();
