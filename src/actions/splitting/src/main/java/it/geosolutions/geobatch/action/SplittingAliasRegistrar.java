...
public class SplittingAliasRegistrar extends AliasRegistrar {
    ...
    public SplittingAliasRegistrar(AliasRegistry registry) {
        LOGGER.info(getClass().getSimpleName() + ": registering alias.");
        registry.putAlias("SplittingConfiguration",
                it.geosolutions.geobatch.action.splitting.SplittingConfiguration.class);
    }
}
