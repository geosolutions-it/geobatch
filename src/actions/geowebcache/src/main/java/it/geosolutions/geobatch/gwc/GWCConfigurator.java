...
public class GWCConfigurator extends GeoWebCacheConfiguratorAction<FileSystemEvent> {
    ...
    protected GWCConfigurator(GeoWebCacheActionConfiguration configuration) throws IOException {
        super(configuration);
    }
    ...
    public Queue<FileSystemEvent> execute(Queue<FileSystemEvent> events)
        ...
        try {
            ...
            String json = getGSLayerData(namespace, store, wmsLayerName, configuration
                    .getGeoserverUrl());
            ...
            StringBuilder bf = buildGWCLayerConfiguration(layerSRS, minX, minY, maxX, maxY,
                    configuration.getGeoserverUrl(), namespace, wmsLayerName, layerName);
     ...
     * @return
     */
    private File[] handleDataFile(Queue<FileSystemEvent> events) {
    ...
    private String getGSLayerData(final String namespace, final String store,
        ...
        try {
            if (namespace != null && layerName != null) {
                ...
                Response response = client.get(geoserverUrl + "rest/workspaces/" + namespace
    ...
    private StringBuilder buildGWCLayerConfiguration(String srs, String minX, String minY,
            String maxX, String maxY, String geoserverUrl, String namespace, String wmsLayerName,
            String layerName) {
    ...
    private boolean sendLayerConfiguration(final StringBuilder buffer, final String gwcUrl,
            final String gwcUser, final String gwcPassword, final String namespace,
