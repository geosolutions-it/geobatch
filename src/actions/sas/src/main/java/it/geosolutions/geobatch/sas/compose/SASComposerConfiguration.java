 ...
 */
public class SASComposerConfiguration
        extends BaseImageProcessingConfiguration
    ...
    public SASComposerConfiguration() {
        super();
    }

    public SASComposerConfiguration(BaseImageProcessingConfiguration imageProcessingConfiguration) {
        super(imageProcessingConfiguration);
    }

    protected SASComposerConfiguration(String id, String name, String description,
            boolean dirty) {
    ...
    public BaseImageProcessingConfiguration clone() { // throws CloneNotSupportedException {
        final SASComposerConfiguration configuration = new SASComposerConfiguration(
