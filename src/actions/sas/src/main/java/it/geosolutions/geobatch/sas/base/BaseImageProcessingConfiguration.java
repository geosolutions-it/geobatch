 ...
 *
 */
public abstract class BaseImageProcessingConfiguration
	...
	public BaseImageProcessingConfiguration(BaseImageProcessingConfiguration other) {
		super();

        this.compressionRatio = other.compressionRatio;
        this.compressionScheme = other.compressionScheme;
        this.corePoolSize = other.corePoolSize;
        this.downsampleStep = other.downsampleStep;
        this.maxPoolSize = other.maxPoolSize;
        this.maxWaitingTime = other.maxWaitingTime;
        this.numSteps = other.numSteps;
        this.scaleAlgorithm = other.scaleAlgorithm;
