...
//	implements Action<FileSystemMonitorEvent> {
	 ...
	 * @throws IOException
	 */
    public MosaicerAction(ActionConfiguration actionConfiguration) throws IOException {
    ...
    protected String buildOutputDirName(final String outputLocation){
    	return SASUtils.buildRunName(outputLocation, configuration.getTime(), MOSAIC_PREFIX);
    }
    ...
    protected String buildFileName(final String outputLocation, final int i,
		...
		final String name = new StringBuilder(outputLocation).append(
				SASUtils.SEPARATOR).append("m_").append(
