 ...
 */
public class SASDetectionConfiguration extends ActionConfiguration implements Configuration {

	public SASDetectionConfiguration(String id, String name, String description, boolean dirty) {
    ...
    public SASDetectionConfiguration() {
        super();
    }
    ...
    public SASDetectionConfiguration clone() { // throws CloneNotSupportedException {
    	try {
			return (SASDetectionConfiguration) BeanUtils.cloneBean(this);
