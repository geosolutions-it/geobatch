...
import it.geosolutions.geobatch.sas.detection.SASDetectionConfiguration;
...
public class SASAliasRegistrar extends AliasRegistrar {
     ...
     public SASAliasRegistrar(AliasRegistry registry) {
         ...
         registry.putAlias("DetectionManagerConfiguration",SASDetectionConfiguration.class);
         registry.putAlias("ComposerConfiguration", SASComposerConfiguration.class);
     }
 }
