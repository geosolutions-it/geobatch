 ...
 */
public class FormatConverterConfiguration
    ...
    public FormatConverterConfiguration(BaseImageProcessingConfiguration processingConfiguration) {
        super(processingConfiguration);
    }
