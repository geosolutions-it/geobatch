 ...
 */
package it.geosolutions.action.tools.test;

import it.geosolutions.geobatch.action.tools.filter.FreeMarker.FreeMarkerAction;
import it.geosolutions.geobatch.action.tools.filter.FreeMarker.FreeMarkerConfiguration;
import it.geosolutions.geobatch.action.tools.filter.FreeMarker.TemplateModelEvent;
...
public class FreeMarkerActionTest {
    ...
    public static void main(String[] args) throws ActionException {
        ...
        mev.put("SOURCE_PATH", "value2");
        mev.put("WORKING_DIR", "value3");
        mev.put("FILE_IN", "IN");
        mev.put("FILE_OUT", "OUT");
