 ...
 * @author Ivano Picco
 * 
 * @deprecated This class won't throw Exceptions, so errors will be diffucult to identify. You may
 *             want to use {@link FTPHelperBare}
 */
public class FTPHelper {
    ...
    public static boolean putBinaryFileTo(String ftpserverHost, String binaryFile, String path,
        ...
        boolean res = putFile(ftpserverHost, binaryFile, path, ftpserverUser, ftpserverPassword,
     ...
     */
    private static boolean putFile(String ftpserverHost, String binaryFile, String path,
        ...
        try {
            ...
            if (LOGGER.isErrorEnabled())
                LOGGER.error("FTP ERROR: " + ftpe.getLocalizedMessage(), ftpe);
            res = false;
        } catch (IOException ioe) {
            if (LOGGER.isErrorEnabled())
                LOGGER.error("FTP ERROR: " + ioe.getLocalizedMessage(), ioe);
            res = false;
        } catch (Throwable t) {
            if (LOGGER.isErrorEnabled())
                LOGGER.error("FTP ERROR: " + t.getLocalizedMessage(), t);
            res = false;
        } finally {
    ...
    public static boolean putTextFileTo(String ftpserverHost, String textFile, String path,
        ...
        boolean res = putFile(ftpserverHost, textFile, path, ftpserverUser, ftpserverPassword,
                ftpserverPort, FTPTransferType.ASCII, writeMode, connectMode, timeout);
     ...
     */
    public static boolean createDirectory(String ftpserverHost, String binaryFile, String path,
            String ftpserverUser, String ftpserverPassword, int ftpserverPort,
            FTPTransferType transferType, WriteMode writeMode, FTPConnectMode connectMode,
            int timeout) {
     ...
     */
    public static boolean downloadFile(String ftpserverHost, String localPath, String remotePath,
     ...
     */
    public static boolean deleteFileOrDirectory(String ftpserverHost, String remoteFile,
            boolean isDir, String remotePath, String ftpserverUser, String ftpserverPassword,
            int ftpserverPort, FTPConnectMode connectMode, int timeout) {
