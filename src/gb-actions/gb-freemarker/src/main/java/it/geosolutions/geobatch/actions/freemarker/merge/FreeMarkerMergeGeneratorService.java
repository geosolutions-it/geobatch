 ...
 *
 */
public class FreeMarkerMergeGeneratorService 
        extends BaseService 
        implements ActionService<FileSystemEvent, FreeMarkerMergeConfiguration> {

    public FreeMarkerMergeGeneratorService(String id, String name, String description) {
