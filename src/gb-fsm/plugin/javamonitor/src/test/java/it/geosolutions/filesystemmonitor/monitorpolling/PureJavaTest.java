...
public class PureJavaTest extends AbstractJUnit4SpringContextTests {
    ...
    public void testPolling() {
        ...
        monitor = ((FileSystemMonitorSPI) this.applicationContext.getBean("pureJavaFSMSPI"))
    ...
    /**
     * FileCreatorThread: Utility thread to create/copy a number of files into a certain directory.
     * 
    ...
    private class FileCreatorThread extends Thread {
        ...
        /**
         * A template output file, if someone don't want to create a fake temp file but use its own.
         */
        ...
        /**
         * Constructor which take as parameters the number of files (if greater than 0), the output
         * dir path and the file suffix.
         * 
         * @param numFiles
         * @param outputDir
         * @param outputExt
         */
        public FileCreatorThread(final int numFiles, final String outputDir, final String outputExt) {
            super();
            if (numFiles > 0)
        ...
        /**
         * Constructor which take as parameters the template output file, the output dir path and
         * the file suffix.
         * 
         * @param outFile
         * @param outputDir
         * @param outputExt
         */
        public FileCreatorThread(final File outFile, final String outputDir, final String outputExt) {
            this(-1, outputDir, outputExt);
            this.outFile = outFile;
        }

        /**
         * Constructor which take as parameters the output dir path and the file suffix.
         * 
         * @param outputDir
         * @param outputExt
         */
        ...
        public void run() {
            try {
                ...
                // //
                tempFile = (this.outFile != null ? this.outFile : File.createTempFile(
                        "FileCreatorThread", this.outputExt));
                ...
                if (this.outputDir == null) {
                    ...
                    final StringBuffer destFileName = new StringBuffer(this.outputDir
                            .getAbsolutePath()).append("\\file_");
