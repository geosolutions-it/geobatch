...
public class FtpConfigDataBean {
	...
	public String toString() {
		...
		builder.append("id=").append(id).append(", loginFailureDelay=").append(
				loginFailureDelay).append(", maxAnonLogins=").append(
				maxAnonLogins).append(", maxLoginFailures=").append(
				maxLoginFailures).append(", maxLogins=").append(maxLogins)
				.append(", port=").append(port).append(", ssl=").append(ssl)
				.append("]");
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((ftpBaseDir == null) ? 0 : ftpBaseDir.hashCode());
