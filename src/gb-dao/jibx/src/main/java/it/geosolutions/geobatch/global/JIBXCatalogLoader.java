 ...
 * 
 */
public class JIBXCatalogLoader extends CatalogHolder implements ApplicationContextAware {

    // enforcing singleton
    private JIBXCatalogLoader(Catalog catalog) {
        CatalogHolder.setCatalog(catalog);
    }

    private static final Logger LOGGER = Logger.getLogger(JIBXCatalogLoader.class.toString());
    ...
    public void init() throws Exception {
        ...
        catalog.setDAO(new JIBXCatalogDAO(dataDir.getAbsolutePath()));
        catalog.load();
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                flow.setDAO(new JIBXFlowConfigurationDAO(dataDir.getAbsolutePath()));
