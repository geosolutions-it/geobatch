 ...
 * <BR>Events are delivered to all the listener in sequence, first to the first
...
{
    protected final static Logger LOGGER = Logger.getLogger(ProgressListenerForwarder.class.toString());
    ...
    public List<? extends IProgressListener> getListeners() {
        return UnmodifiableArrayList.wrap(listeners.toArray(new IProgressListener[listeners.size()]));
    }
}
