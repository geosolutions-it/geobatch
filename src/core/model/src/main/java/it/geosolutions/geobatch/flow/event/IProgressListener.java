 ...
 * 
 * <P>This Listner is designed to have stateful information, such as current task 
 * running or current progress percentage, so it should be bound to one object only.
 *
