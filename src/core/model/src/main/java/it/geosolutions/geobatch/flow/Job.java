...
public interface Job {
	 ...
	 * for instance the job may not be split in execution steps, loop iterations
	 * and so on; in this case the <TT>pause()</TT> invocation may simply return
	 * <TT>false</TT>, indicating to the caller that the job was not paused.
	 * 
	 ...
	 * 
	 * @return <TT>true</TT> if the Job has been successfully paused,
	 *         disregarding any return values from its subjobs.
	 */
	public boolean pause(boolean sub);

	/**
	 * Resume a previously paused job. <BR>
	 * If the instance does not support pausing or it was not paused, nothing
	 * will happen.
	 */
	public void resume();
