...
public class FileBasedFlowManagerTestCase {
	...
	private final static Logger LOGGER = Logger
			.getLogger(FileBasedFlowManagerTestCase.class.toString());
	...
	@Test
	public void testFSFlowManagerService() throws IOException,
		...
		//
		// //
		Object o = context.getBean("fsFlowManagerService",
				FileBasedFlowManagerService.class);
		...
		eventGeneratorConfiguration.setWorkingDirectory(TestData
		...
		eventConsumerConfiguration
				.setDescription("fsEventConsumerConfiguration");
		eventConsumerConfiguration.setWorkingDirectory(TestData.file(this, ".")
				.getAbsolutePath());

		final FileEventRule rule = new FileEventRule();
		rule.setAcceptableNotifications(Arrays
				.asList(FileSystemMonitorNotifications.FILE_ADDED));
		...
		flowConfiguration.setWorkingDirectory(TestData.file(this, ".")
				.getAbsolutePath());
		flowConfiguration
				.setEventConsumerConfiguration(eventConsumerConfiguration);
		flowConfiguration
				.setEventGeneratorConfiguration(eventGeneratorConfiguration);
		...
		final FileBasedFlowManager eg = service
				.createFlowManager(flowConfiguration);
