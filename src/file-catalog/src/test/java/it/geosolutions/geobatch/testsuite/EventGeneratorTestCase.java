 ...
 * 
 */
public class EventGeneratorTestCase implements
		FlowEventListener<FileSystemMonitorEvent> {

	private final static Logger LOGGER = Logger
			.getLogger(EventGeneratorTestCase.class.toString());
	...
	@Test
	public void testFileBasedEventGeneratorService() throws IOException,
		...
		//
		// //
		Object o = context.getBean("fsEventGeneratorService",
				FileBasedEventGeneratorService.class);
		...
		configuration.setWorkingDirectory(TestData.file(this, ".")
				.getAbsolutePath());
		...
		final FileBasedEventGenerator eg = service
				.createEventGenerator(configuration);
	...
	public void eventGenerated(FileSystemMonitorEvent event) {
		...
		try {
			Assert.assertTrue(event.getSource().getAbsolutePath()
					.equalsIgnoreCase(
