...
public class FileBasedEventGenerator<T extends EventObject> extends BaseEventGenerator<T>
{
    ...
    private void initialize(final FileBasedEventGeneratorConfiguration configuration)
    {
        ...
        else
        {
            ...
            {
                LOGGER.warn("FileBasedEventGenerator.initialize(): Provided wild card is null, using default ( * )");
            }
        }
...
//WORKAROUND
                ...
                this.watchDirectory.canRead())
        {
            ...
            this.fsMonitor = FSMSPIFinder.getMonitor(params, configuration.getOsType(), configuration.getMonitorType());
    ...
    */
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            throw new IllegalArgumentException(
                "FileBasedEventGenerator: The object is not a FileBasedEventGenerator.");
        }
    ...
    private final class GBEventListener implements FileSystemListener
    {
         ...
         * #fileMonitorEventDelivered (it.geosolutions.filesystemmonitor.monitor.FileSystemEvent)
         */
        public void onFileSystemEvent(final FileSystemEvent fe)
        {
            if ((fe != null) && (fe.getSource() != null))
            {
                ...
                if (LOGGER.isInfoEnabled())
                {
                    LOGGER.info(new StringBuilder("Event: ").append(incomingEvent.toString()).append(" ").append(fe.getSource()).toString());
                }
