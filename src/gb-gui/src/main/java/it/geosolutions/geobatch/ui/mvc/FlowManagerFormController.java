...
public class FlowManagerFormController extends SimpleFormController {
    ...
    protected Object formBackingObject(HttpServletRequest request) throws Exception {
        ...
        /*
         * The backing object should be set up here, with data for the initial values of the
         * form�s fields. This could either be hard-coded, or retrieved from a database, perhaps
...
//        logger.info("Returning backing object");
    ...
    protected ModelAndView onSubmit(Object command, BindException errors) throws Exception {
        ...
        // catalog.getFlowManager(givenData.getDescriptorId(),
        // FileBasedCatalogConfiguration.class);
        ...
        // }
        //
        // FlowManager fm = catalog.getResource(givenData.getId(),
        // FlowManager.class);
        //
        // if (fm != null) {
        // errors.rejectValue("id", "error.code",
        // "The Flow Manager ID specified already exists.");
        //
        // return new ModelAndView(getFormView(), errors.getModel());
        // }
        // fm =
        // fmDescriptor.getFlowManagerService().createFlowManager(fmDescriptor);
        // ((FileBasedFlowManagerImpl) fm).setId(givenData.getId());
        // ((FileBasedFlowManagerImpl) fm).setName(givenData.getName());
        // ((FileBasedFlowManagerImpl) fm).setInputDir(new
        // File(givenData.getInputDir()));
        // ((FileBasedFlowManagerImpl) fm).setOutputDir(new
        // File(givenData.getOutputDir()));
        // catalog.add(fm);
