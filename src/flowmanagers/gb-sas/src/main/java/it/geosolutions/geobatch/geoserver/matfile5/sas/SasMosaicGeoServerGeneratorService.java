...
public class SasMosaicGeoServerGeneratorService extends
    ...
    private final static Logger LOGGER = Logger.getLogger(SasMosaicGeoServerGenerator.class
            .toString());

    public SasMosaicGeoServerGenerator createAction(GeoServerActionConfiguration configuration) {
        try {
            return new SasMosaicGeoServerGenerator(configuration);
        } catch (IOException e) {
